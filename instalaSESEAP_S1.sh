			...
			versionNoGraficaPlana()
				{
					...
					sudo perl -i -pe "s/\"read\": \".*?\"/\"read\": \"read:$clientScopeRead\"/" appsettings.json
					sudo perl -i -pe "s/\"write\": \".*?\"/\"write\": \"write:$clientScopeWrite\"/" appsettings.json
					...
					sudo docker build -t api-interconexion-puebla -f Dockerfile .
					echo "= = = = = = = = = = = = = = = = = = = = = = = P A S O  3  D E S P L I E G U E = = = = = = = = = = = = = = = = = = = ="
					echo -e "\033[33mID de la imagen dentro del contenedor Docker es:\033[0m"
					#Comandos especiales
					#export DOCKER_HOST_IP=$(route -n | awk '/UG[ \t]/{print $2}')
					echo "= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = ="
					# Ejecutamos el contenedor con el nombre definitivo
					sudo docker run --restart always --name api-interconexion-puebla -p $deploymentPort:80 -d api-interconexion-puebla
